		 ...
		 <div class="row  row-background border-bottom">
			<div class="col-md-3 d-flex justify-content-between align-items-center">
				...
				<div class="col-md-5  d-flex justify-content-start align-items-center">
					<button type="button" class="btn btn-success btn-sm" id="">Generate Report</button>
					<button type="button" class="btn btn-success btn-sm ml-2" id="submitPayments">Print Report</button>
				</div>
		</div>
