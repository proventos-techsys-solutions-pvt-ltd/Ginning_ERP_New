...
public class CashAddModeTag extends SimpleTagSupport{
	...
	public static JSONArray getAccountCats() {			
		...
		try {
			 ...
			 String accountQuery = "Select unique acc_ledger, account_id, company_id from general_ledger where acc_category_id=1 or acc_category_id = 3 order by acc_ledger";
